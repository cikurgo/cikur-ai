 ...
 * Turns the Investigator from a probe planner into an evidence-driven
...
export function createInvestigationEngine(caseData, knowledge={}, options={}) {
  ...
  async function step(currentCase, provider, knowledgeOverride=knowledge) {
    ...
    const stopStates=new Set(["SOURCE_VERIFIED","CANDIDATE_READY","APPLICATION_ACTION_REVIEW","USER_CONFIRMATION","APPLYING_CHANGE","VERIFYING_RESULT","RESOLVED"]);
...
export { VERSION, buildConcreteSolution };
