...
import { db, auth } from "./cikur-config.js?v=20260907-1315-instruction1";
...
export function runAutonomousEngine(onCycleUpdate) {
  ...
  async function loadInternalAI() {
    ...
    try {
      const mod = await import("./cgo-runtime-adapter.js?v=20260907-1315-instruction1");
      ...
      try {
        const mod = await import("./cgo-ai-browser-adapter.js?v=20260907-1315-instruction1");
